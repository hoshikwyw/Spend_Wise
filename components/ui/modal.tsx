      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
          ...
          <motion.div
            ...
            className={cn(
              "relative w-full sm:max-w-md bg-bg-secondary/95 backdrop-blur-xl rounded-t-[2rem] sm:rounded-[var(--radius-card)] p-6 shadow-hover border border-border/30 z-10",
              className
            )}
          >
            {/* Header */}
